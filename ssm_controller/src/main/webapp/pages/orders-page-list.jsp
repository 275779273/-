                        ...
                        <ul class="pagination">
                            ...
                            <li>
                                <a href="${pageContext.request.contextPath}/orders/findAll.do?page=1&size=${pageInfo.pageSize}"
                                   aria-label="Previous" id="a01">首页</a>
                            </li>
                            <li>
...
<script>
    ...
    //    var text2 = $("select option")[i].text;
    //    if(text2==size){
    //        var obj = $("select option")[i];
